...
import Navbar, { isMobileDevice } from "../components/NavbarComponent"
...
function Main() {
    ...
    useEffect(() => {
        if(isMobile !== null) dynamicClasses();
    }, [isMobile])
    ...
    return (
        <>
            ...
            <div className={(!isMobile ? "container" : "container10") + " text-white"}>
                <h1 className={(!isMobile ? "header" : "mobileHeader") + " margin-0-auto margin-top-2"}>Let’s bring order and share knowledge!</h1>
                <div className="margin-top-2">
                    <div className={(isMobile ? "margin-bottom-5" : "grid col2-1 gap1 margin-bottom-1") + " "}>
                        <div id="panelItText" className={(isMobile ? "margin-bottom-2 containerSkew z-index-1Neg bgBlueS" : "order-2 window") + " padding-top-1-25"}>
                        ...
                        <div className={(isMobile ? "border-none bgTransparent positionRelative left-6vWNeg z-index-1Neg margin-top-1" : "order-1 overFlowHidden") + " window padding-1-0-1-2 cardHeight"}>
                    ...
                    <div className={(isMobile ? "" : "grid col1-2 gap1") + " "}>
                        <div className={(isMobile ? "border-none bgTransparent Jpr[l:0px] z-index-1Neg margin-bottom-2" : "overFlowHidden") + " window padding-1-0-1-2 cardHeight"}>
                            <div className={(isMobile ? "flex-direction-reverse-rows" : "") + " flex justify-space-bwt"}>
                                <div>
                                    ...
                                    <p className={(isMobile ? "text-end" : "") + " cardText margin-0 text-light"}>Create cards that you can put <span className="text-bold">anywhere.</span></p>
                                </div>
                        ...
                        <div className={(isMobile ? "border-none bgTransparent positionRelative left-6vWNeg z-index-1Neg" : "overFlowHidden") + " window cardHeight padding-1-0-1-2"}>
                            <div className={(isMobile ? "" : "") + " flex justify-space-bwt"}>
                                <div>
                                    <h3 className={(isMobile ? "lenguajeSizeMobile" : "lenguajeSize") + " cardTitle margin-0 text-light text-noWrap"}>Steps Cards</h3>
